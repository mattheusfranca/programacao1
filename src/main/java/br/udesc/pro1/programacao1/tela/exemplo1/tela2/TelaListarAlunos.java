...
public class TelaListarAlunos extends javax.swing.JFrame {
    ...
    public void inicializarListaAlunos(){
        ...
        for(Aluno a: alunos){
            textAreaListaAlunos.append(a.toString() + "\n");
        }
    }
    ...
    private void initComponents() {
        ...
        textAreaListaAlunos = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);

        textAreaListaAlunos.setEditable(false);
        textAreaListaAlunos.setColumns(20);
        textAreaListaAlunos.setRows(5);
        jScrollPane1.setViewportView(textAreaListaAlunos);
    ...
    private javax.swing.JTextArea textAreaListaAlunos;
