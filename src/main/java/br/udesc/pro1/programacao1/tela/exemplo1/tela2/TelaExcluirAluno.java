...
public class TelaExcluirAluno extends javax.swing.JFrame {
    ...
    public void inicializarListaAlunos(){
        ...
        ArrayList<Aluno> alunos = TelaCadastrarAluno.getAlunos();
        for(Aluno a: alunos){
            cbAlunos.addItem(a);
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(cbAlunos, javax.swing.GroupLayout.PREFERRED_SIZE, 597, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(29, 29, 29))
    ...
    public void excluirAluno(){
        //Selecionar o aluno
        Aluno alunoSelecionado = (Aluno) cbAlunos.getSelectedItem(); //retorna um Object. Convertemos por meio de Casting.
        //Remover o aluno do BD
        TelaCadastrarAluno.excluirAluno(alunoSelecionado);
        //Exibir uma msg
        exibirMensagem("Aluno excluido com sucesso");
        
        //Reinicializar a lista de alunos
        inicializarListaAlunos();        
    }
